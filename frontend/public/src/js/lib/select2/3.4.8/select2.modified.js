                ...
                this.opts.query({
                    ...
                    if (data.more===true) {
                       // more.detach().appendTo(results).text(evaluate(self.opts.formatLoadMore, page+1));
                        more.detach().appendTo(results).html(evaluate(self.opts.formatLoadMore, page+1));
        ...
        updateResults: function (initial) {
            ...
            opts.query({
                ...
                if (data.more === true && checkFormatter(opts.formatLoadMore, "formatLoadMore")) {
                    ...
                    var loading = self.opts.escapeMarkup(evaluate(opts.formatLoadMore, this.resultsPage));
                    var li_el = $("<li class='select2-more-results'></li>");
                    li_el.append(loading);
